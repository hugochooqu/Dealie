      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 text-center md:text-left fade-in ">
            ...
            AI-Powered  <span className='text-blue-600 animate-pulse'>Negotiation</span> Chat System 
            </h1>
            ...
            <div className="mt-8">
              <Link
                href="/demo"
                className="inline-block bg-blue-600 text-white px-6 py-3 rounded-xl text-lg font-medium hover:bg-blue-800"
              >
                Start Demo
              </Link>
            </div>
